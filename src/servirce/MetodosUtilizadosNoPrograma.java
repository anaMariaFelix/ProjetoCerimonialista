...
public class MetodosUtilizadosNoPrograma {
	...
	public Cliente criaCliente() {
		...
		char sexoValido = MetodosUtilizadosNoPrograma.pegarCharUsuario(sexo,"sexo");
		
		String cpf = pegarCPFUsuario();
		System.out.print("Email: ");
		String email = entrada.nextLine();

		Cliente cliente = new Cliente(nome, TipoSexo.valueOf(String.valueOf(sexoValido)), cpf, email);
	...
	public void exibeInformacoesDeUmClienteEspecifico(Cliente cliente) {
	...
	public boolean criarNovoEvento(Cliente cliente, CentralDeInformacoes centralDeInformacoes) {
